...
-(BOOL)fn_create_table{
    ...
    if (![database open]) {
        ...
        NSString *ls_sql_systemIcon = @"CREATE TABLE IF NOT EXISTS systemIcon( unique_id INTEGER PRIMARY KEY,ic_name TEXT NOT NULL DEFAULT '',ic_content TEXT NOT NULL DEFAULT '',upd_date TEXT NOT NULL DEFAULT '')";
         NSString *ls_sql_crmopp_browse = @"CREATE TABLE IF NOT EXISTS crmopp_browse( unique_id INTEGER PRIMARY KEY,uid TEXT NOT NULL DEFAULT '',opp_id TEXT NOT NULL DEFAULT '',opp_code TEXT NOT NULL DEFAULT '',opp_ref_type TEXT NOT NULL DEFAULT '',opp_ref_id TEXT NOT NULL DEFAULT '',opp_ref_code TEXT NOT NULL DEFAULT '',opp_ref_name TEXT NOT NULL DEFAULT '',opp_ref_addr TEXT NOT NULL DEFAULT '',opp_ref_addr_01 TEXT NOT NULL DEFAULT '',opp_ref_addr_02 TEXT NOT NULL DEFAULT '',opp_ref_addr_03 TEXT NOT NULL DEFAULT '',opp_ref_addr_04 TEXT NOT NULL DEFAULT '',opp_name TEXT NOT NULL DEFAULT '',contact_id TEXT NOT NULL DEFAULT '',contact_code TEXT NOT NULL DEFAULT '',contact_name TEXT NOT NULL DEFAULT '',contact_tel TEXT NOT NULL DEFAULT '',contact_email TEXT NOT NULL DEFAULT '',contact_mobile TEXT NOT NULL DEFAULT '',opp_stage TEXT NOT NULL DEFAULT '',opp_stage_desc TEXT NOT NULL DEFAULT '',opp_stage_lang TEXT NOT NULL DEFAULT '',exp_close_date TEXT NOT NULL DEFAULT '',opp_remark TEXT NOT NULL DEFAULT '',opp_probability TEXT NOT NULL DEFAULT '',assign_to TEXT NOT NULL DEFAULT '',assign_to_name TEXT NOT NULL DEFAULT '',campaign_id TEXT NOT NULL DEFAULT '',campaign_name TEXT NOT NULL DEFAULT '',op_type TEXT NOT NULL DEFAULT '',load_main_region_code TEXT NOT NULL DEFAULT '',load_main_region_name TEXT NOT NULL DEFAULT '',load_main_region_lang TEXT NOT NULL DEFAULT '',load_sub_region_code TEXT NOT NULL DEFAULT '',load_sub_region_name TEXT NOT NULL DEFAULT '',load_sub_region_lang TEXT NOT NULL DEFAULT '',load_region_code TEXT NOT NULL DEFAULT '',load_region_name TEXT NOT NULL DEFAULT '',load_code TEXT NOT NULL DEFAULT '',load_name TEXT NOT NULL DEFAULT '',dish_main_region_code TEXT NOT NULL DEFAULT '',dish_main_region_name TEXT NOT NULL DEFAULT '',dish_main_region_lang TEXT NOT NULL DEFAULT '',dish_sub_region_code TEXT NOT NULL DEFAULT '',dish_sub_region_name TEXT NOT NULL DEFAULT '',dish_sub_region_lang TEXT NOT NULL DEFAULT '',dish_region_code TEXT NOT NULL DEFAULT '',dish_region_name TEXT NOT NULL DEFAULT '',dish_code TEXT NOT NULL DEFAULT '',dish_name TEXT NOT NULL DEFAULT '',dest_code TEXT NOT NULL DEFAULT '',dest_name TEXT NOT NULL DEFAULT '',srvc_code TEXT NOT NULL DEFAULT '',srvc_desc TEXT NOT NULL DEFAULT '',movement_code TEXT NOT NULL DEFAULT '',movement_desc TEXT NOT NULL DEFAULT '',inco_term TEXT NOT NULL DEFAULT '',inco_term_desc TEXT NOT NULL DEFAULT '',inco_term_lang TEXT NOT NULL DEFAULT '',brand TEXT NOT NULL DEFAULT '',competitor_rmk TEXT NOT NULL DEFAULT '',volume TEXT NOT NULL DEFAULT '',cbm_annual TEXT NOT NULL DEFAULT '',teu_annual TEXT NOT NULL DEFAULT '',kgs_annual TEXT NOT NULL DEFAULT '',fcl_lcl TEXT NOT NULL DEFAULT '',voided TEXT NOT NULL DEFAULT '',rec_crt_user TEXT NOT NULL DEFAULT '',rec_upd_user TEXT NOT NULL DEFAULT '',rec_crt_date TEXT NOT NULL DEFAULT '',rec_upd_date TEXT NOT NULL DEFAULT '',rec_upd_type TEXT NOT NULL DEFAULT '',rec_savable TEXT NOT NULL DEFAULT '',rec_deletable TEXT NOT NULL DEFAULT '',is_modified TEXT NOT NULL DEFAULT '')";
         ...
         NSString *ls_sql_crmtask_browse = @"CREATE TABLE IF NOT EXISTS crmtask( unique_id INTEGER PRIMARY KEY,uid TEXT NOT NULL DEFAULT '',task_id TEXT NOT NULL DEFAULT'',task_ref_id TEXT NOT NULL DEFAULT '',task_ref_type TEXT NOT NULL DEFAULT '',task_ref_code TEXT NOT NULL DEFAULT '',task_ref_name TEXT NOT NULL DEFAULT '',contact_id TEXT NOT NULL DEFAULT '',contact_code TEXT NOT NULL DEFAULT '',contact_name TEXT NOT NULL DEFAULT '',contact_email TEXT NOT NULL DEFAULT '',contact_mobile TEXT NOT NULL DEFAULT '', contact_tel TEXT NOT NULL DEFAULT '',task_ref_addr TEXT NOT NULL DEFAULT '',task_ref_addr_01 TEXT NOT NULL DEFAULT '',task_ref_addr_02 TEXT NOT NULL DEFAULT '',task_ref_addr_03 TEXT NOT NULL DEFAULT '',task_ref_addr_04 TEXT NOT NULL DEFAULT '',task_title TEXT NOT NULL DEFAULT '',task_desc TEXT NOT NULL DEFAULT '',task_start_date TEXT NOT NULL DEFAULT '',task_end_date TEXT NOT NULL DEFAULT '',task_report TEXT NOT NULL DEFAULT '',task_sm_report TEXT NOT NULL DEFAULT '',duration_ttl TEXT NOT NULL DEFAULT '',duration_hr TEXT NOT NULL DEFAULT '',duration_min TEXT NOT NULL DEFAULT '',duration_str TEXT NOT NULL DEFAULT '',assign_to TEXT NOT NULL DEFAULT '',assign_to_name TEXT NOT NULL DEFAULT '',voided TEXT NOT NULL DEFAULT '',rec_crt_user TEXT NOT NULL DEFAULT '',rec_upd_user TEXT NOT NULL DEFAULT '',rec_crt_date TEXT NOT NULL DEFAULT '',rec_upd_date TEXT NOT NULL DEFAULT '',rec_upd_type TEXT NOT NULL DEFAULT '',rec_savable TEXT NOT NULL DEFAULT '',rec_deletable TEXT NOT NULL DEFAULT '',task_type TEXT NOT NULL DEFAULT '',task_type_desc TEXT NOT NULL DEFAULT '',task_type_lang TEXT NOT NULL DEFAULT '',task_status TEXT NOT NULL DEFAULT '',task_status_desc TEXT NOT NULL DEFAULT '',task_status_lang TEXT NOT NULL DEFAULT '',quo_uid TEXT NOT NULL DEFAULT '',quo_no TEXT NOT NULL DEFAULT '',task_date_period TEXT NOT NULL DEFAULT '',report_mail TEXT NOT NULL DEFAULT '',report_submit TEXT NOT NULL DEFAULT '',is_modified TEXT NOT NULL DEFAULT '')";
        NSString *ls_sql_crmhbl_browse = @"CREATE TABLE IF NOT EXISTS crmhbl_browse( unique_id INTEGER PRIMARY KEY,acct_id TEXT NOT NULL DEFAULT '',hbl_uid TEXT NOT NULL DEFAULT '',acct_name TEXT NOT NULL DEFAULT '',op_type TEXT NOT NULL DEFAULT '',desc TEXT NOT NULL DEFAULT '',hbl_update_date TEXT NOT NULL DEFAULT '')";
        NSString *ls_sql_crmcontact_browse = @"CREATE TABLE IF NOT EXISTS crmcontact( unique_id INTEGER PRIMARY KEY,uid TEXT NOT NULL DEFAULT '',contact_id TEXT NOT NULL DEFAULT'',contact_code TEXT NOT NULL DEFAULT '',contact_type TEXT NOT NULL DEFAULT '',contact_ref_id TEXT NOT NULL DEFAULT '',contact_ref_name TEXT NOT NULL DEFAULT '',contact_ref_code TEXT NOT NULL DEFAULT '',contact_name TEXT NOT NULL DEFAULT '',contact_title TEXT NOT NULL DEFAULT '',contact_dept TEXT NOT NULL DEFAULT '',contact_mobile TEXT NOT NULL DEFAULT '', contact_tel TEXT NOT NULL DEFAULT '',contact_fax TEXT NOT NULL DEFAULT '',contact_email TEXT NOT NULL DEFAULT '',contact_language TEXT NOT NULL DEFAULT '',lang_desc TEXT NOT NULL DEFAULT '',assign_to TEXT NOT NULL DEFAULT '',assign_to_name TEXT NOT NULL DEFAULT '',voided TEXT NOT NULL DEFAULT '',rec_crt_user TEXT NOT NULL DEFAULT '',rec_upd_user TEXT NOT NULL DEFAULT '',rec_crt_date TEXT NOT NULL DEFAULT '',rec_upd_date TEXT NOT NULL DEFAULT '',rec_upd_type TEXT NOT NULL DEFAULT '',rec_savable TEXT NOT NULL DEFAULT '',rec_deletable TEXT NOT NULL DEFAULT '',is_modified TEXT NOT NULL DEFAULT '')";
        
         NSString *ls_sql_crmquo_browse = @"CREATE TABLE IF NOT EXISTS crmquo_browse( unique_id INTEGER PRIMARY KEY,uid TEXT NOT NULL DEFAULT '',quo_uid TEXT NOT NULL DEFAULT '',quo_no TEXT NOT NULL DEFAULT '',nature TEXT NOT NULL DEFAULT '',issue_date TEXT NOT NULL DEFAULT '',cst_id TEXT NOT NULL DEFAULT '',cst_code TEXT NOT NULL DEFAULT '',cst_name TEXT NOT NULL DEFAULT '',addr_01 TEXT NOT NULL DEFAULT '',addr_02 TEXT NOT NULL DEFAULT '',addr_03 TEXT NOT NULL DEFAULT '',addr_04 TEXT NOT NULL DEFAULT '',addr_05 TEXT NOT NULL DEFAULT '',acct_id TEXT NOT NULL DEFAULT '',acct_code TEXT NOT NULL DEFAULT '',acct_name TEXT NOT NULL DEFAULT '',cst_attn TEXT NOT NULL DEFAULT '',cst_tel TEXT NOT NULL DEFAULT '',cst_fax TEXT NOT NULL DEFAULT '',remark TEXT NOT NULL DEFAULT '',ft_remark TEXT NOT NULL DEFAULT '',credit_remark TEXT NOT NULL DEFAULT '',header_remark TEXT NOT NULL DEFAULT '',min_amt TEXT NOT NULL DEFAULT '',load_code TEXT NOT NULL DEFAULT '',load_name TEXT NOT NULL DEFAULT '',dish_code TEXT NOT NULL DEFAULT '',dish_name TEXT NOT NULL DEFAULT '',dest_code TEXT NOT NULL DEFAULT '',dest_name TEXT NOT NULL DEFAULT '',via_port TEXT NOT NULL DEFAULT '',via_port_name TEXT NOT NULL DEFAULT '',load_region_name TEXT NOT NULL DEFAULT '',load_region_code TEXT NOT NULL DEFAULT '',dest_region_name TEXT NOT NULL DEFAULT '',dest_region_code TEXT NOT NULL DEFAULT '',confirm TEXT NOT NULL DEFAULT '',min_curr TEXT NOT NULL DEFAULT '',min_curr_name TEXT NOT NULL DEFAULT '',effective_date TEXT NOT NULL DEFAULT '',expiry_date TEXT NOT NULL DEFAULT '',place_of_receipt TEXT NOT NULL DEFAULT '',salesman_code TEXT NOT NULL DEFAULT '',salesman_name TEXT NOT NULL DEFAULT '',one_time TEXT NOT NULL DEFAULT '',info_uid TEXT NOT NULL DEFAULT '',fcl_lcl TEXT NOT NULL DEFAULT '',carr_name TEXT NOT NULL DEFAULT '',cntr_p1 TEXT NOT NULL DEFAULT '',cntr_p2 TEXT NOT NULL DEFAULT '',cntr_p3 TEXT NOT NULL DEFAULT '',cntr_p4 TEXT NOT NULL DEFAULT '',pkg_unit_code TEXT NOT NULL DEFAULT '',pkg TEXT NOT NULL DEFAULT '',cbm TEXT NOT NULL DEFAULT '',kgs TEXT NOT NULL DEFAULT '',charge_desc TEXT NOT NULL DEFAULT '',rec_crt_user TEXT NOT NULL DEFAULT '',rec_upd_user TEXT NOT NULL DEFAULT '',rec_crt_date TEXT NOT NULL DEFAULT '',rec_upd_date TEXT NOT NULL DEFAULT '',rec_upd_type TEXT NOT NULL DEFAULT '',rec_savable TEXT NOT NULL DEFAULT '',rec_deletable TEXT NOT NULL DEFAULT '')";
        NSString *ls_sql_com_sys_code=@"CREATE TABLE IF NOT EXISTS com_sys_code( unique_id INTEGER PRIMARY KEY,sys_code TEXT NOT NULL DEFAULT '',lang_code TEXT NOT NULL DEFAULT '')";
        ...
        [database executeUpdate:ls_sql_crmcontact_browse];
        [database executeUpdate:ls_sql_crmquo_browse];
